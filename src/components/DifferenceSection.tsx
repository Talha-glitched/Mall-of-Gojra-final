  ...
  return (
    <section className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[600px] bg-gradient-to-r from-yellow-400/10 via-purple-500/10 to-yellow-400/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          className="backdrop-blur-xl bg-gradient-to-br from-yellow-400/10 to-purple-600/10 border border-yellow-400/30 rounded-3xl p-12 text-center"
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="space-y-3">
              <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-yellow-400/20 to-yellow-600/20 flex items-center justify-center">
