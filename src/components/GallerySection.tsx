  ...
  return (
    <section className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-gradient-to-br from-[rgba(var(--brand-gold-rgb),0.05)] to-purple-600/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-2xl text-xl sm:text-2xl text-white/100">
